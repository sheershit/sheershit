...
<p align="left"> 
  <img src="https://komarev.com/ghpvc/?username=sheershit&label=Profile%20views&color=0e75b6&style=flat" alt="sheershit" /> 
</p>
...
<br>
<div align="center">
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExM3Npa3Y2aDFoZWkyZ3QxN2VtYjN1eWkwbHZqNGt6ZzB1aG5qNW1tZSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/L8K62iI8aU8Gm8EOy6/giphy.gif" width="300" alt="Data Brain GIF">
</div>
<br>

- 🎓 My **Information Technology** degree gives me an edge, providing a deep understanding of how data is structured, processed, and stored efficiently, which is crucial for complex analysis.
...
* **Data Storyteller & Visualizer:** I don't just present numbers. I build compelling narratives and interactive dashboards (Power BI) that make complex data easy for anyone to understand and act upon.
* **Technical & Meticulous Analyst:** I thrive on the technical side of data. I write clean, efficient SQL to query data and use tools like Power Query and Excel to meticulously clean and transform messy datasets into reliable sources of truth.
* **Proactive Problem-Solver:** I am driven by a "why" mindset. I'm not satisfied with just *what* the data says, but *why* it says it, and I'm always looking for the next question to ask to get to the root of a problem.
...
<br>
<div align="center">
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExbG1sM3QxbHg2c2NleWxkeTY3cWtvcXpoeG9kZHZqaGF4bHRqYTFtbiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/SbYNF2K0hS0MxFQ2Nl/giphy.gif" width="300" alt="Dashboard Building GIF">
</div>
<br>
...
-   **Business Acumen:** I focus on connecting data insights back to the "so what?"—how does this analysis affect business goals, operations, or strategy?
...
<br>
<div align="center">
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExM2Fvb2x5c2E5b2RxZzB5dWcyYjFicHFtN3N4c3JtbGZjeG5wZGd6eSZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/j09EaQCg2lY9O5sW6S/giphy.gif" width="350" alt="Connecting Dots GIF">
</div>
<br>
...
4.  **Visualize & Report:** I choose the right visualization for the data (Power BI, Excel) to make it understandable at a glance. The goal is to build a clear and interactive dashboard.
...
<br>
<div align="center">
  <img src="https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExZDVuc2RqcGRlbnA4M3lxeG5vMXBjcjRyeG01ZnN5N2R6cTF5eGhocyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/3owvKaY5pqDUSsS168/giphy.gif" width="300" alt="Business Strategy GIF">
</div>
<br>

-   **Business Intelligence (BI):** Building comprehensive dashboards that serve as a "single source of truth" to help leadership track KPIs and make informed decisions.
-   **Customer & Marketing Analytics:** Analyzing customer behavior, segmentation, and campaign performance to understand "what works" and how to improve customer retention.
- S **Operational Analytics:** Investigating internal processes, identifying bottlenecks, and finding opportunities for efficiency gains through data.
-   **Financial Analytics:** Understanding sales performance, tracking revenue trends, and analyzing financial health to support strategic planning.
